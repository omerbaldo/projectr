 ...
 */
public class login extends AppCompatActivity implements LoaderCallbacks<Cursor>, Handler.Callback{
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            mAuthTask = new UserLoginTask(mFragmentHandler, email, password);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            System.out.println("Going to attempt login with username  " + mEmail + " password " + mPassword);

            if(Intro.sesh.attemptLogin(mEmail,mPassword) == false){
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                /*
                  ...
                  Here redirect it to the user profile page/ user dashboard
